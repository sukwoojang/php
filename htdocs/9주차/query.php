...
if ($cnt != 0) {
	...
	print "<table border = 1><tr><td><b><center>학번</center></b></td><td><b><center>이름</center></b></td></tr>";
	for ($i = 0; $i < $cnt ;$i++){#for문 용법 알아두자
		...
		print "<td><input type = submit value = '삭제'></td></tr><input type = hidden name = 'id' value = $row[stud_id]></form>";
	}
	print "</table>";
